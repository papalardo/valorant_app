...
class AgentModule extends Module {
  ...
  List<Bind> get binds {
    return [
      ...
      Bind.factory<AgentsRepositoryInterface>((i) => AgentsRepository(i())),
      Bind.lazySingleton<AgentBloc>((i) => AgentBloc(repository: i())),
    ];
  }
  ...
  List<ModularRoute> get routes {
    return [
      ChildRoute(Routes.agentView, child: (_, args) {
