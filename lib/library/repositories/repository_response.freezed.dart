...
/// @nodoc
abstract class $RepositoryResponseCopyWith<T, $Res> {
  factory $RepositoryResponseCopyWith(RepositoryResponse<T> value,
          $Res Function(RepositoryResponse<T>) then) =
      _$RepositoryResponseCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$RepositoryResponseCopyWithImpl<T, $Res>
    implements $RepositoryResponseCopyWith<T, $Res> {
  _$RepositoryResponseCopyWithImpl(this._value, this._then);

  final RepositoryResponse<T> _value;
  // ignore: unused_field
  final $Res Function(RepositoryResponse<T>) _then;
}
...
class __$$DataSourceSuccessResponseCopyWithImpl<T, $Res>
    extends _$RepositoryResponseCopyWithImpl<T, $Res>
...
class _$DataSourceSuccessResponse<T> implements DataSourceSuccessResponse<T> {
  ...
  @override
  String toString() {
    return 'RepositoryResponse<$T>.success(data: $data)';
  }
...
abstract class DataSourceSuccessResponse<T> implements RepositoryResponse<T> {
...
class _$DataSourceFailureResponse<T> implements DataSourceFailureResponse<T> {
  ...
  @override
  String toString() {
    return 'RepositoryResponse<$T>.failure(error: $error)';
  }
...
abstract class DataSourceFailureResponse<T> implements RepositoryResponse<T> {
